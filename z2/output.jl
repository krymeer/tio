...
function createchart(bvarray::Array{Int64,1}, wvarray::Array{Int64,1}, avarray::Array{Float64,1}, crossprob::Float64, mutprob::Float64, muttype::String, seltype::String)
  n       = length(bvarray)
  ...
  draw(SVG("out/out_knapsack__"* seltype *"_c_"* string(crossprob) *"_m_"* string(mutprob) *"_"* muttype *"__"* suffix *".svg", 1200px, 900px), myplot)
end